...
const fridge = () => {
  ...
  app.prepare = async () => {
    app.render =
      dev || app.nextConfig.skipCache ? app.render.bind(app) : renderWithCache;
    ...
    if (
      !dev &&
      app.nextConfig.exportPathMap &&
      app.nextConfig.useExportRoutes
    ) {
